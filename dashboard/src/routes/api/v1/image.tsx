...
import { resolveRange, resolveMachineId } from "@/lib/api-utils";
import { queryProjectDaily, queryDailyTotals, queryLanguages } from "@/lib/db.server";
import { formatDuration, rangeLabel } from "@/lib/stats";
                  ...
                  >
                    {projects.map((p, i) => {
                      ...
                      return (
                        ...
                        >
                          <span style={{ display: "flex", fontSize: 12, color: TEXT, width: 160 }}>
                            {name}
                          </span>
                          <div style={{ display: "flex", flexDirection: "row", width: TRACK_W, height: 10 }}>
                            <div style={{ width: filled, height: 10, background: color, borderRadius: 3 }} />
                            {empty > 0 && (
                              <div style={{ width: empty, height: 10, background: BORDER, borderRadius: 3 }} />
                            )}
                          </div>
                          <span
                            style={{
